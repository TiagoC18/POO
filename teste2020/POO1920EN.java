...
import teste.ClasseEnergetica;
import teste2020.Produto.classeEnergetica;
...
public class POO1920EN {
	...
	private static void alinea1(PrintStream out) {
		...
		livro1.setQuantidade(100);
		out.println(livro1.getTitulo() + " tem " + livro1.getAutores().size() + " autores");
		...
		electr1.setClasseEnergetica(classeEnergetica.A);
		...
		tv1.setClasseEnergetica(classeEnergetica.A);
		tv1.addQuantidade(5);
		...
		//
		tlm1.addQuantidade(2);
				
		out.println("AUTORES DE " + livro1.getTitulo() + ": " + livro1.getAutores());
