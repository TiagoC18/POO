...
public class VideoClubTester {
    public static void main(String[] args) {
        ...
        r.add(new Pessoa("Joao", 1231245, new DateYMD(1, 1, 2000)));
        r.add(new Pessoa("Carlos", 23424, new DateYMD(1, 10, 2003)));
        r.add(new Pessoa("Marta", 3423, new DateYMD(31, 3, 2002)));
        r.add(new Pessoa("Ricardo", 786675, new DateYMD(14, 7, 2000)));
        r.add(new Pessoa("Paula", 65423, new DateYMD(3, 6, 2001)));
